"use strict";
(self["webpackChunkwww_tracktunes_org"] = self["webpackChunkwww_tracktunes_org"] || []).push([["node_modules_ionic_core_dist_esm_ion-modal_entry_js"],{
...
const Modal = class {
  ...
  initSwipeToClose() {
    ...
    this.gesture = createSwipeToCloseGesture(this.el, ani, () => {
      ...
      this.animation.onFinish( /*#__PURE__*/(0,_home_dtal_repos_www_tracktunes_org_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
